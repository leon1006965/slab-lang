...
def compile_image(node: Node) -> list:
    ...
    lines.append(f'        while _w > 400 or _h > 400:')
    lines.append(f'            _w, _h = _w // 2, _h // 2')
    lines.append(f'        _pil_img = _pil_img.resize((_w, _h))')
    lines.append(f'        _img = ImageTk.PhotoImage(_pil_img)')
